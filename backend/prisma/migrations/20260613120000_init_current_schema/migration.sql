...
-- CreateEnum
CREATE TYPE "PurchasePaymentStatus" AS ENUM ('PENDIENTE', 'PAGADA', 'VENCIDA', 'PARCIAL');
...
CREATE TABLE "purchases" (
    ...
    "estado_pago" "PurchasePaymentStatus" NOT NULL DEFAULT 'PENDIENTE',
    "factura_url" TEXT,
    "factura_key" TEXT,
    "factura_nombre" TEXT,
    "factura_mime" TEXT,
    "factura_ocr_texto" TEXT,
    "factura_ocr_json" JSONB,
    "observaciones" TEXT,
    "estado" "EstadoGeneral" NOT NULL DEFAULT 'ACTIVO',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "expenses" (
    ...
    "comprobante_ia_texto" TEXT,
    "comprobante_ia_json" JSONB,
    "fecha" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "tenant_ai_settings" (
    ...
    "enterprise_included" BOOLEAN NOT NULL DEFAULT false,
    ...
    "ollama_url" TEXT,
    "ollama_vision_model" TEXT DEFAULT 'llava:latest',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "purchases_tenant_id_estado_pago_idx" ON "purchases"("tenant_id", "estado_pago");

-- CreateIndex
CREATE INDEX "purchases_tenant_id_fecha_vencimiento_idx" ON "purchases"("tenant_id", "fecha_vencimiento");
...
-- CreateIndex
CREATE INDEX "tenant_ai_settings_tenant_id_id_idx" ON "tenant_ai_settings"("tenant_id", "id");
